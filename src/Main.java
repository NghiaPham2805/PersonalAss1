...
//        return payments;
//    }
//    private static void printPaymentList() {
...
//    }
//    private static void printRentalAgreementList() {
...
//
//
//    // Step 1: Read all the data from text file then store into all the lists, then delete all the files
//    // Step 2: When the program run, use the list to perform all the functionality
//    // Step 3: When the program end, save the data back to the text file
//
//
...
//        System.out.println("6. Manage Rental Agreements");
...
//        }
//    }
//    private static void manageRentalAgreements() {
...
//        System.out.println("5. Edit Rental Agreement");
...
//                    break;
//                case 5:
//                    System.out.println("Edit Rental Agreement");
//                    manageRentalAgreements(scanner);
//                    break;
//                case 6:
...
//    private static void viewRole(String role) {
...
//        System.out.println("===================================================================================");
//        System.out.printf("%-10s %-15s %-15s %-10s %-15s %-10s%n", "Property ID", "Type", "Address", "Price", "Status", "Owner ID");
//        System.out.println("===================================================================================");
//        for (Property property : propertyList) {
//            System.out.printf("%-10s %-15s %-15s %-10.2f %-15s %-10s%n",
...
//    private static void manageRentalAgreements(Scanner scanner) {
